...
import { Cpu, Layers, Code2, Server, Database, Lock, Rocket, Sparkles, CheckCircle2, Copy, Check, ArrowRight, ShieldCheck, Plus, MessageSquareText, X, Terminal, Activity, Key, FileText } from "lucide-react";
...
export function BlueprintViewer({ blueprint, onGenerateCustomProblem, onGenerateRoadmap }: BlueprintViewerProps) {
  ...
  const tabs = [
    ...
    { id: "prompts", label: "AI Coding Prompts 📋", icon: Sparkles },
  ];
          ...
          <CardHeader className="pb-3 border-b border-slate-800 flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription className="text-xs text-slate-400">
                Provide your custom project idea or problem statement to generate a tailored technical blueprint.
              </CardDescription>
            </div>
            <button
